/*
 * @fileoverview    {ServicioPoliciaImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
import com.project.dev.backend.repositorio.RepositorioPolicia;
...
import com.project.dev.backend.servicio.mapeo.MapeoPolicia;
