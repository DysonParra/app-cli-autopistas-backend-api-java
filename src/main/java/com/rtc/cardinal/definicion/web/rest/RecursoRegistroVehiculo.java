/*
 * @fileoverview {RecursoRegistroVehiculo} se encarga de realizar tareas especificas.
 *
 * @version             1.0
 *
 ...
 *
 * @History v1.0 --- La implementacion de {RecursoRegistroVehiculo} fue realizada el 31/07/2022.
 * @Dev - La primera version de {RecursoRegistroVehiculo} fue escrita por Dyson A. Parra T.
 */
...
import com.rtc.cardinal.definicion.web.rest.ensamblador.EnsambladorRecursoRegistroVehiculo;
